...
(chid, quantity, specified_location, t_start, t_stop, t_step, id_meshes, dimension_1, dimension_2, dim1, dim2, delta_dim_1, delta_dim_2, geometry, dim1_min, dim1_max, dim2_min, dim2_max, exits, delta_mesh_exit) = pickle.load(f)
