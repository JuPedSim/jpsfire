...
if not os.path.exists('../2_toxicity_grids/%s/%s_%.6f'%(quantity, specified_location[0], specified_location[1])):
    print 'create directory "2_toxicity_grids"'
    os.makedirs('../2_toxicity_grids/%s/%s_%.6f'%(quantity, specified_location[0], specified_location[1]))
...
for time in times:
    ...
    np.savetxt('../2_toxicity_grids/%s/%s_%.6f/t_%.6f.csv'%(quantity, specified_location[0], specified_location[1], time), consolidated, header=header, delimiter=',', comments='')
    ...
    if plots == True:
        ...
        plt.savefig('../2_toxicity_grids/%s/%s_%.6f/t_%.6f.pdf'%(quantity, specified_location[0], specified_location[1], time))
