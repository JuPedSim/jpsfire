...
if not os.path.exists('../2_toxgrids/%s_%.2f/%s'%(specified_location[0], specified_location[1], quantity)):
    print 'create directory "2_toxgrids"'
    os.makedirs('../2_toxgrids/%s_%.2f/%s'%(specified_location[0], specified_location[1], quantity))
...
for time in times:
    ...
    if plots == True:
        ...
        plt.savefig('../2_toxgrids/%s_%.2f/%s/t_%.6f.pdf'%(specified_location[0], specified_location[1], quantity, time))
